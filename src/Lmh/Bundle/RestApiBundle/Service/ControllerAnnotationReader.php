...
namespace Lmh\Bundle\RestApiBundle\Service;

use Lmh\Bundle\RestApiBundle\Annotation\Api as ApiAnnotation;
...
class ControllerAnnotationReader
{
    ...
    const ANNOTATION_CLASS_API = 'Lmh\\Bundle\\RestApiBundle\\Annotation\\Api';
     ...
     * @return \Lmh\Bundle\RestApiBundle\Annotation\Api
     */
     ...
     * @return \Lmh\Bundle\RestApiBundle\Annotation\Api,FALSE
     */
